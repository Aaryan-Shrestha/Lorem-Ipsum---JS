...
form.addEventListener("submit", function (e) {
  e.preventDefault();
  const value = parseInt(amount.value); // IT RETURNS A STRING TYPE SO CONVERT IT TO A NUMBER TYPE USING 'parseInt()' METHOD
  const random = Math.floor(Math.random() * text.length);
  // empty string, < 0 , > 9
  // isNaN() IS A FUNCTION WHICH RETURNS TRUTHY/FALSY VALUE ->
  // TRUTHY VALUE REFERING TO: (true,1,'hello',{},[],etc.)
  // FALSY VALUE REFERING TO: (0,-1,null,undefined,"",NaN,false,etc.)
